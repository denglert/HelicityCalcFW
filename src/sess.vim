...
nmap 0l :!latexmk -pdf %
nmap 0p :!gnuplot %
nmap 9Ã¶ istd::cerr << " " << std::endl;6bli
map Q gq
...
nmap <F4> :!make PIDSetup
imap 	 <Plug>SuperTabForward
inoremap  u
imap -= // Debuggg <BS><BS><BS>std::cerr << " " << std::endl;6bli
imap 9Ã¶ std::cerr << " " << std::endl;6bli
nmap Ã¶Ã¼ :!latexmk -pdf thesis.tex
imap jj 
let &cpo=s:cpo_save
unlet s:cpo_save
...
set mouse=a
set ruler
set runtimepath=~/.vim/bundle/vundle,~/.vim/bundle/supertab,~/.vim/bundle/vim-easymotion,~/.vim/bundle/nerdtree,~/.vim/bundle/vim-colors-solarized,~/.vim,~/lib/build/vim/vimfiles,~/lib/build/vim/runtime/,~/lib/build/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/supertab/after,~/.vim/bundle/vim-easymotion/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/vim-colors-solarized/after
set shiftwidth=4
set showcmd
...
silent only
cd ~/lib/projects/helicity/HelicityFW/src
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 119 - ((28 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 278 - ((29 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
278
